...
REPO_URL=$(git -C "$SCRIPT_DIR_ROOT" remote get-url origin 2>/dev/null || echo "https://github.com/markjkelly/cloud-workstations.git")
...
timeout: 7200s
substitutions:
  _REPO_URL: 'https://github.com/markjkelly/cloud-workstations.git'
  _REGION: 'us-west1'
  _WEBHOOK_URL: ''
  _EMAIL_FUNC_URL: ''
  _EMAIL: ''
