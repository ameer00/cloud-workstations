...
| F-0110 | Add boot tests for new workspace layout | [F-0108](specs/F-0108-workspace-autostart-remap.md) | P0 | implemented | SWE-1 | feature/workspace-remap | F-0108, F-0109 | 6 tests added to 10-tests.sh: ws1/2/3=foot, ws4=chrome via sway_exec, no antigravity, chrome binary exists. Pending SWE-Test verification. |
